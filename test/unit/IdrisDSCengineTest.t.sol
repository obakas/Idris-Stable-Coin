...
contract IdrisDSCEngineTest is StdCheats, Test {
    ...
    IdrisDSCengine public dsce;
    IdrisStablecoin public dsc;
    ...
    function setUp() external {
        DeployIdrisDSC deployer = new DeployIdrisDSC();
    ...
    function testRevertsIfTokenLengthDoesntMatchPriceFeeds() public {
        ...
        vm.expectRevert(IdrisDSCengine.DSCEngine__TokenAddressesAndPriceFeedAddressesAmountsDontMatch.selector);
    ...
    //     vm.prank(owner);
    //     IdrisDSCengine mockDsce = new IdrisDSCengine(tokenAddresses, feedAddresses, address(mockDsc));
    ...
    //     // Act / Assert
    //     vm.expectRevert(IdrisDSCengine.DSCEngine__TransferFailed.selector);
    ...
    function testRevertsIfCollateralZero() public {
        ...
        vm.expectRevert(IdrisDSCengine.DSCEngine__NeedsMoreThanZero.selector);
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        vm.startPrank(user);
        vm.expectRevert(abi.encodeWithSelector(IdrisDSCengine.DSCEngine__TokenNotAllowed.selector, address(randToken)));
    ...
    //     vm.expectRevert(IdrisDSCengine.DSCEngine__MintFailed.selector);
    ...
    //     // Arrange - Setup
    //     MockMoreDebtDSC mockDsc = new MockMoreDebtDSC();
    //     tokenAddresses = [weth];
    //     feedAddresses = [ethUsdPriceFeed];
    //     address owner = msg.sender;
    //     vm.prank(owner);
    ...
    //     MockV3Aggregator(ethUsdPriceFeed).updateAnswer(ethUsdUpdatedPrice);
    //     // Act/Assert
    //     vm.expectRevert(IdrisDSCengine.DSCEngine__HealthFactorNotImproved.selector);
    ...
    function testCantLiquidateGoodHealthFactor() public depositedCollateralAndMintedDsc {
        ...
        vm.expectRevert(IdrisDSCengine.DSCEngine__HealthFactorOk.selector);
